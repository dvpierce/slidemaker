...
The Hamming Distance (named after [Richard Hamming](https://en.wikipedia.org/wiki/Richard_Hamming) of Bell Labs) is then the amount of difference between the two fingerprints: the higher the number, the less similar the images are.
